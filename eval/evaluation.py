...
def aggregate_eval_results(eval_results):
    ...
    eval_results["overall_score"]["memory_integrity"]["recall(all)"] = memory_integrity_scores / memory_integrity_num if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0 if memory_integrity_num > 0 else 0
    eval_results["overall_score"]["memory_integrity"]["recall(valid)"] = memory_integrity_scores / memory_integrity_valid_num if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0 if memory_integrity_valid_num > 0 else 0
    eval_results["overall_score"]["memory_integrity"]["weighted_recall(all)"] = memory_integrity_weighted_scores / memory_integrity_weighted_num if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0 if memory_integrity_weighted_num > 0 else 0
    eval_results["overall_score"]["memory_integrity"]["weighted_recall(valid)"] = memory_integrity_weighted_scores / memory_integrity_weighted_valid_num if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0 if memory_integrity_weighted_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["memory_accuracy"]["interference_accuracy(all)"] = interference_memory_scores / interference_memory_num if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0 if interference_memory_num > 0 else 0
    eval_results["overall_score"]["memory_accuracy"]["interference_accuracy(valid)"] = interference_memory_scores / interference_memory_valid_num if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0 if interference_memory_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["memory_accuracy"]["target_accuracy(all)"] = target_memory_accuracy_scores / target_memory_accuracy_num if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0 if target_memory_accuracy_num > 0 else 0
    eval_results["overall_score"]["memory_accuracy"]["target_accuracy(valid)"] = target_memory_accuracy_scores / target_memory_accuracy_valid_num if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0 if target_memory_accuracy_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["memory_accuracy"]["weighted_accuracy(all)"] = memory_accuracy_weighted_scores / memory_accuracy_num if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0 if memory_accuracy_num > 0 else 0
    eval_results["overall_score"]["memory_accuracy"]["weighted_accuracy(valid)"] = memory_accuracy_weighted_scores / memory_accuracy_valid_num if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0 if memory_accuracy_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["memory_update"]["correct_update_memory_ratio(all)"] = correct_update_memory_num / update_memory_num if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0
    eval_results["overall_score"]["memory_update"]["correct_update_memory_ratio(valid)"] = correct_update_memory_num / update_memory_valid_num if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["memory_update"]["hallucination_update_memory_ratio(valid)"] = hallucination_update_memory_num / update_memory_valid_num if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0
    eval_results["overall_score"]["memory_update"]["omission_update_memory_ratio(all)"] = omission_update_memory_num / update_memory_num if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0
    eval_results["overall_score"]["memory_update"]["omission_update_memory_ratio(valid)"] = omission_update_memory_num / update_memory_valid_num if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0
    eval_results["overall_score"]["memory_update"]["other_update_memory_ratio(all)"] = other_update_memory_num / update_memory_num if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0 if update_memory_num > 0 else 0
    eval_results["overall_score"]["memory_update"]["other_update_memory_ratio(valid)"] = other_update_memory_num / update_memory_valid_num if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0 if update_memory_valid_num > 0 else 0
    ...
    eval_results["overall_score"]["question_answering"]["correct_qa_ratio(all)"] = correct_qa_num / qa_num if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0
    eval_results["overall_score"]["question_answering"]["correct_qa_ratio(valid)"] = correct_qa_num / qa_valid_num if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0
    eval_results["overall_score"]["question_answering"]["hallucination_qa_ratio(all)"] = hallucination_qa_num / qa_num if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0
    eval_results["overall_score"]["question_answering"]["hallucination_qa_ratio(valid)"] = hallucination_qa_num / qa_valid_num if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0
    eval_results["overall_score"]["question_answering"]["omission_qa_ratio(all)"] = omission_qa_num / qa_num if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0 if qa_num > 0 else 0
    eval_results["overall_score"]["question_answering"]["omission_qa_ratio(valid)"] = omission_qa_num / qa_valid_num if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0 if qa_valid_num > 0 else 0
    ...
    for key in eval_results["overall_score"]["memory_type_accuracy"]:
        eval_results["overall_score"]["memory_type_accuracy"][key]['memory_integrity_acc'] = eval_results["overall_score"]["memory_type_accuracy"][key]['memory_integrity_acc'] / eval_results["overall_score"]["memory_type_accuracy"][key]['total_num'] if eval_results["overall_score"]["memory_type_accuracy"][key]['total_num'] > 0 else 0
